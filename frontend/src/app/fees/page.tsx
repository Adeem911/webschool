            ...
            <tbody className="bg-white divide-y divide-gray-100">
              {loading ? (
                ...
                <tr key={family.family_id} className="hover:bg-gray-50 transition">
                  <td className="px-6 py-4 whitespace-nowrap font-semibold text-gray-900">{family.family_name}</td>
                  <td className="px-6 py-4 whitespace-nowrap text-gray-700">{family.contact_number}</td>
                  <td className="px-6 py-4 whitespace-nowrap text-gray-700">{family.email}</td>
